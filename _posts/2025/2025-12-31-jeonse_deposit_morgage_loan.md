...
| :--- | :--- | :--- | :--- | :--- |
| **1주택자 (규제지역)** | '25.6.27 이전 | 70% | DTI 60% (역전세 반환 시) | 보증금 차액 범위 내 (최대 LTV까지) |
| **1주택자 (규제지역)** | **'25.6.28 이후** | **40%** | **DSR 40% (원칙)** | **최대 1억 원 제한** |
| **다주택자/임대사업자** | '25.6.27 이전 | 70% | RTI 1.0배 (완화) | 역전세 반환 목적에 한함 |
| **다주택자/임대사업자** | '25.6.28 이후 | 0 | RTI 1.25~1.5배 (정상) | 강화된 규제 적용 |
